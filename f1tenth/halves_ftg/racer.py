...
class HalvesRacer(FollowTheGapRacer):
    ...
    def _adjust_target_position(self, position_x: float, position_y: float, heading_angle: float):
        ...
        import math
        print(self._mpc.target_x, self._mpc.target_y, position_x, position_y)
        print(heading_angle, -math.atan2(self._mpc.target_x - position_x, self._mpc.target_y - position_y))
